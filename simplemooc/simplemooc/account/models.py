...
class User(AbstractBaseUser, PermissionsMixin):
    ...
    is_active = models.BooleanField('Está Ativo?', blank=True, 
                        default=True)
    is_staff = models.BooleanField('É da equipe?', blank=True, 
                        default=True)
    date_joined = models.DateTimeField('Data de inscrição', 
                            auto_now_add=True)
